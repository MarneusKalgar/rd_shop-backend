...
export class AddRolesAndScopesToUsers1771872698451 implements MigrationInterface {
  name = 'AddRolesAndScopesToUsers1771872698451';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "users" ADD "roles" text array NOT NULL DEFAULT '{}'`);
    await queryRunner.query(`ALTER TABLE "users" ADD "scopes" text array NOT NULL DEFAULT '{}'`);
    await queryRunner.query(`DROP INDEX "public"."IDX_orders_status_created"`);
    await queryRunner.query(
